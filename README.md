...
Kun Data provides real-time market data for Indonesia through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Indonesia market coverage with support for IDX.

## API Capabilities

- Real-time WebSocket market data for Indonesia
...
This repository is designed to make Indonesia market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/indonesia-stock-market-api
