# Indonesia stock market API

Real-time Indonesia stock market API with WebSocket, OHLCV, and snapshot endpoints for IDX.

## Build With Indonesia Market Data

Kun Data provides a token-authenticated API stack for developers who need Indonesia market data in products that must load fast, stream live prices, and support charting or screening workflows.

This repository is focused on Indonesia coverage with support for IDX and is designed for teams building broker dashboards, watchlists, quant tools, stock screeners, mobile apps, and market overview pages.

## Why Developers Search For This

Developers usually need one or more of these:

- Real-time Indonesia stock market API
...
`Indonesia stock market API | IDX API | Indonesia stock data API | Indonesia OHLCV API`
...
### Does this support real-time Indonesia market data?
...
If you need Indonesia market data coverage for IDX, start with the product page and documentation:
