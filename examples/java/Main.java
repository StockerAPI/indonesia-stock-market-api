...
public class Main {
    ...
    private static final String MARKET = "ID";
    private static final String EXCHANGE = "IDX";
    private static final String SYMBOL = "IDX:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"IDX:000040\",\"IDX:005930\"],\"replay\":\"last\"}";
